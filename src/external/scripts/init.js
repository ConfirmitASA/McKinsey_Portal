...
function cavani_tm_modalbox() {
  ...
  jQuery('.cavani_tm_all_wrap').prepend(
    '<div class="cavani_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
...
function cavani_tm_portfolio_popup() {
  ...
  button.off().on('click', function() {
    ...
    modalBox
      .find('.popup_details')
      .prepend(
        '<div class="top_image"><img src="https://survey.us.confirmit.com/isa/BDJPFRDMEYBPBKLVADAYFQCDAVIOEQJR/cavani/4-2.jpg" alt="" /><div class="main" data-img-url="' +
          image +
          '"></div></div>'
      );
    modalBox
...
function cavani_tm_news_popup() {
  ...
  button.on('click', function() {
    ...
    modalBox
      ...
      .prepend(
        '<div class="image"><img src="https://survey.us.confirmit.com/isa/BDJPFRDMEYBPBKLVADAYFQCDAVIOEQJR/cavani/4-2.jpg" alt="" /><div class="main" data-img-url="' +
          image +
          '"></div></div>'
      );
    modalBox
