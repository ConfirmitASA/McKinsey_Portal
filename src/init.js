...
function cavani_tm_portfolio_popup(){
    ...
    button.off().on('click',function(){
        ...
        modalBox.find('.popup_details').prepend('<div class="top_image"><img src="https://survey.us.confirmit.com/isa/BDJPFRDMEYBPBKLVADAYFQCDAVIOEQJR/cavani/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
function cavani_tm_news_popup(){
    ...
    button.on('click',function(){
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="https://survey.us.confirmit.com/isa/BDJPFRDMEYBPBKLVADAYFQCDAVIOEQJR/cavani/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
function cavani_tm_service_popup(){
    ...
    button.on('click',function(){
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.service_popup_informations').prepend('<div class="image"><img src="https://survey.us.confirmit.com/isa/BDJPFRDMEYBPBKLVADAYFQCDAVIOEQJR/cavani/4-2.jpg" alt="" /><div class="main" data-img-url="'+elImage+'"></div></div>');
        cavani_tm_data_images();
