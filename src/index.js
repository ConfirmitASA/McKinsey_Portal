...
const Help = [
    {
        ImageUrl: "https://images.pexels.com/photos/792199/pexels-photo-792199.jpeg?auto=compress&cs=tinysrgb&w=1600",
        Subject: "Submit a Ticket",
        Text: "Something unexpected has happened in the Employee Listening Hub, and I would like to submit a support ticket."
    },

    {
        ImageUrl: "https://images.pexels.com/photos/3771074/pexels-photo-3771074.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
        Subject: "Schedule Training",
        Text: "I have questions about the Employee Listening Hub, and would like to schedule a training session."
    },

    {
        ImageUrl: "https://images.pexels.com/photos/1194775/pexels-photo-1194775.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
...

    {
        ...
        Text: "My scores are not where they need to be, and I'd like McKinsey to help me resolve the underlying issues in my business."
    }
...
const Partners = {
    ...
    'mck': {
        MainImgUrl: "https://www.mckinsey.com/~/media/mckinsey/business%20functions/mckinsey%20digital/our%20insights/the%20top%20trends%20in%20tech%202022/the-top-technology-trends-of-2022_1296421142_thumb_1536x1536-v3.jpg", // "https://www.mckinsey.com/~/media/mckinsey/careers%20redesign/forward/forward-page-thumb_1536x1536_1076927118.jpg",
        LogoUrl: "https://www.freelogovectors.net/wp-content/uploads/2022/06/mckinsey-logo-freelogovectors.net_.png"
    },


    'forsta': {
        MainImgUrl: "https://images.pexels.com/photos/1147124/pexels-photo-1147124.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
        LogoUrl: "https://assets.greenbook.org/logos/Forsta_Logo_RGB_FINAL_no%20space%20around-01%20(002)_pp1490558637792249377658838.png"
    }
...
const Products = {
    ...
    '1': {
        ...
        Description: "An organization’s health—its ability to align around and achieve strategic goals—is critical for long-term performance. However, many leaders overlook organizational health because they lack a clear way to measure and improve it. Organizational Health Index (OHI) applies analytical rigor to organizational health management. Our quantitative diagnostics and proven recipes for success empower senior leaders to measure and achieve the organizational health required to sustain long-term performance.",

        SurveyUrl: "https://survey.us.confirmit.com/wix/p436156196230.aspx",


        Icons: {
            Thumbnail: 'https://www.mckinsey.com/~/media/mckinsey/mckinsey%20solutions/orgsolutions/overview/ohi/ohi_thumb_151329137_1536x1536.jpg?mw=677&car=42:25',

            Main: 'https://www.mckinsey.com/~/media/mckinsey/mckinsey%20solutions/orgsolutions/overview/ohi/ohi-half-hero_151329137_1536x768.jpg?mw=1536&car=19:10&cpx=Right&cpy=Center'
        },
        ...
        Benefits: [
            {
                ...
                Text: 'The OHI benchmark provides leaders with a detailed picture of their organizations’ health compared to peers. With over 1 billion data points across geographies and industries, it offers a global standard to measure and manage organizational health.'

            },

            {
                Title: 'Align your organization',
                Text: 'Sustained performance requires different functions, teams, geographies, and tenure levels to share a common set of goals and priorities. The OHI helps leaders find the disconnects and get everyone on the same page.'

            },

            {
                Title: 'Drive organizational performance',
                Text: 'The OHI survey and benchmarking data explain up to 50 percent of performance variations within companies. This helps leaders analyze the impact of company practices and culture on performance and create an implementation roadmap to improve it.'
            }
        ],
            ...
            */
            ...
            Layout: {
                ...
                Contents: {
                    Palette: {
                        Label: 'Theme',
                        Description: 'Select a layout theme for your OHI survey. Choose from three standard themes.',
                        Type: 'Dropdown',
                        DefaultValue: 'mckinsey',
                        Options: {
                            'mckinsey': {Label: 'McKinsey', Data: ['#051C2C', '#2251FF', '#F0F0F0', '#F5F6FA']},
                            'minty': {Label: 'Minty', Data: ['#21D59B', '#e4f9fc', '#0058ff', '#F5F6FA']},
                            'neutral': {Label: 'Neutral', Data: ['#FFFFFF', '#50C878', '#F5F6F8', '#F5F6FA']}
                        },
                        HasPreview: true
                    },
                }
            ...
            Contents: {
                ...
                Description: "Selections on this tab decide what optional questions - on top of standard questions and content - will be included in your OHI survey.",
                Contents: {

                    OpenEnds: {
                        Label: 'Open-ended Questions',
                        Description: 'Select additional open-ended questions for your OHI survey. You may leave all unchecked.',
                        Type: 'Multi',
                        Options: {
                            'q1': {Label: 'Describe $company$ in three words.'},
                            'q2': {Label: 'What are $company$\'s strengths?'},
                            'q3': {Label: 'What are $company$\'s opportunities for improvement?'},
                            'q4': {Label: 'Please take a few moments to add any additional thoughts or suggestions?'}
                        }
                    },
    ...
    '3': {
        ...
        TagLine: 'Keep track of the sentiment of your organization and close the loop with your employees.',

        Description: "In every organization, the changing nature of work and the broader environment impact employees’ experiences. If you’re only measuring once every 6 or 12 months, you could be missing these shifting attitudes. Using a simple, lightweight attitude check on a weekly basis you can keep tabs on how the whole company is reacting to the shifting world around them. In addition, it gives people the option to request further follow-up; which drives engagement, willingness to respond, and gives your team in-depth insight that you otherwise would have missed.",

        SurveyUrl: "https://survey.us.confirmit.com/wix/p596224084960.aspx",


        Icons: {
            Thumbnail: 'https://images.pexels.com/photos/6203473/pexels-photo-6203473.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',

            Main: 'https://images.pexels.com/photos/6203473/pexels-photo-6203473.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
        },
        ...
        Config: {
            ...
            Notifications: {
                ...
                Contents: {
                    NotificationEmail: {
                        Label: 'Email',
                        Description: '(Optional) Email address to receive notifications from employees who request to be contacted.',
                        Type: 'Open',
                        DefaultValue: '',
                        HasPreview: false
                    },
    ...
    '2': {
        ...
        Description: 'In high-performing organizations, dynamic teams address top priorities with the right talent in the right roles. But creating that kind of workplace requires understanding where value really comes from and ensuring the right work is being done in the right structure. OrgLab offers a powerful platform for designing a better organization and then guiding the steps needed to make lasting change.',

        Icons: {
            Main: 'https://images.pexels.com/photos/8101985/pexels-photo-8101985.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
            Thumbnail: 'https://images.pexels.com/photos/8101985/pexels-photo-8101985.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
        },

        Benefits: [
            {
                Title: 'Talent to value',
                Text: 'We put value at the center of operating model work, identifying the most critical roles throughout the organization and ensuring that top talent is deployed where it matters.'
            },

            {
                Title: 'Smart delayering',
                Text: 'Our advanced analytics highlight opportunities to optimize spans of control and reduce excessive layers, empowering efficient management and faster decision making.'
            },

            {
                Title: 'Team effectiveness',
                Text: 'We employ tools to visualize the teams within an organization, quickly identifying capability and capacity gaps and identifying opportunities to make teamwork more efficient.'
            }
        ],
...
function PreviewPalette() {
    ...
    var colors = Products[active_project.ProductId].Config.Layout.Contents.Palette.Options[value].Data;
    var o = [];

    var palette = [];
    for (var i = 0; i < colors.length; ++i)
        palette.push(`<td style="border: 2px solid white; height: 20px; width: 24px; background-color:${colors[i]}"></td>`);
...
function RenderForm(target_id, form_id, definition) {
    ...
    for (var tab_id in definition) {
        ...
        tabs.push('<div class="tile tab" style="font-size: 15px" id="tab-' + tab_id + '">' + tab_html + '</div>');
        ...
        if (tab.Description)
            o.push('<div style="font-weight: 300; margin-bottom: 12px; color: #00a9f4; margin-right: 20px; font-size: smaller;">' + tab.Description + '</div>');
        ...
        for (var key in contents) {
            ...
            // Heading
            o.push('<span style="position: relative; left: 30px; top: 12px; padding: 0px 10px; background-color: white; font-size: x-small; text-transform: uppercase; letter-spacing: 1.5px;">');
            o.push(DynamicText(obj.Label));
            o.push('</span>');


            // Box
            o.push('<div id="" style="font-weight: 300; color: black; padding: 20px 20px 0 20px; border: 1px solid #c0c0c0; margin-bottom: 30px;  margin-right: 20px; padding-bottom: 20px">');
            ...
            switch (obj.Type) {
                ...
                case 'Open':
                    ...
                    var value = c[key] != null
                        ? c[key]
                        : obj.DefaultValue;

                    tmp.push(`<input value="${value}" id="${key}" style="min-width: 250px; padding: 10px; display: block; margin: 20px 0px 0px 0px; background-color: #F6FBFF; ;">`);
                    // /Open
                ...
                case 'Dropdown':
                    ...
                    tmp.push('<select id="' + key + '" style="min-width: 250px; display: block; margin: 20px 0px 0px 0px; background-color: #f0f0f0;">');
                    for (var option_code in obj.Options) {
                        var option = obj.Options[option_code];
                        tmp.push(
                            '<option value="' + option_code + '" style=""' + (
                    ...
                    if (obj.HasPreview) {
                        // Preview
                        tmp.push('<div style="padding: 20px 0 0 0" id="preview-' + key + '">' + "Preview" + '</div>');
                        // /Preview

                        scripts.push('Preview' + key + '();');
                        scripts.push('$("#' + key + '").change(function(){Preview' + key + '();});');
                    }
                    ...
                    for (var option_code in obj.Options) {
                        ...
                        tmp.push(
                            `<div style="margin: 10px 0">
								<input ${values_map[value] ? ' checked ' : ''} type="checkbox" id="${value}" name="${key}" value="${value}">
								<label style="color: #000; font-size: smaller; position: relative; top: -2px" for="${value}">${DynamicText(option.Label)}</label>
							</div>`
                        );
                    }
                    o.push('</fieldset>');
...
function ActivateProject(project, prevent_redirect) {
    ...
    var items = [
        {Time: 'Sep 2022', Text: 'Project Created', Subtext: active_project.DisplayName},
...
function LoadProducts() {
    ...
    $('.add-project-button').click(
        function () {
            ...
            if (token == null) {
                new Notify("Error", "You need to log in first.", 'error', {autoClose: false});
            } else {
                var id = $(this).attr('id');
    ...
    $('.demo').click(function (e) {
        ...
        var o = [];
        o.push(
            '<iframe style="scale: 0.8; background-color: white; width: 100vw; height: 100vh;" src="' + url + '">',
            '</iframe>'
        );
...
// Project Tiles
    ...
    for (var i = 0; i < records.length; ++i) {
        ...
        o.push('<div class="project-tile-wrapper">');
        o.push('<div class="project-tile" id="help-tile-' + i + '" xonclick="javascript:ActivateProjectId(' + record.ProjectId + ');" class=project>');

        //o.push ( '<div class="project-created-date" style="float: right">' + created_date.toISOString().split('T')[0] + '</div>' );
        o.push('<div class="project-image" style="margin-top: 20px; background-image: url(' + record.ImageUrl + ')"></div>');
        o.push('<div class="project-display-name">' + record.Subject + '</div>');
        o.push('<div style="width:80px;margin-left: 82.5px; margin-top: 10px; border-top: 1px solid #e0e0e0;"></div>');
        o.push('<div class="project-type" style="height: 80px">' + record.Text + '</div>');
...
function PopulateProjectList(activate_newest_project) {
    ...
    for (var i = 0; i < records.length; ++i) {
        ...
        o.push('<div class="project-tile-wrapper" id="project-tile-wrapper-' + record.ProjectId + '">');
        o.push('<div class="project-tile" id="project-tile-' + record.ProjectId + '" onclick="javascript:ActivateProjectId(' + record.ProjectId + ');" class=project>');

        o.push('<div class="project-created-date" style="float: right">' + created_date.toISOString().split('T')[0] + '</div>');
        o.push('<div class="project-image" style="background-image: url(' + Products[record.ProductId].Icons.Main + ')"></div>');
    ...
    if (activate_newest_project && projects.length > 0)
        ActivateProject(projects[0], true); // if we just added a new one (will be first in list)
...
function DownloadPowerPoint_OHI(data) {
    ...
    pptx.defineSlideMaster({
        ...
        objects: [
            {image: {path: 'mckinsey_logo.jpg', x: 0.4, y: 0.15, w: logo_width, h: logo_width * logo_ratio}},
            {image: {path: 'image2.png', x: "0%", y: 0, w: bg_width, h: bg_width * bg_ratio}}
        ],
    });
    ...
    pptx.defineSlideMaster({
        ...
        objects: [
            {image: {path: 'mckinsey_logo.jpg', x: 0.4, y: 0.15, w: logo_width, h: logo_width * logo_ratio}},
            {image: {path: 'quote.png', x: 0.4, y: 1.5, w: quote_width, h: quote_ratio * logo_ratio}},
            {image: {path: 'face.jpg', x: "44%", y: 0, w: face_width, h: face_width * face_ratio}}
        ],
    });
    ...
    let slide = pptx.addSlide({masterName: "Master1", sectionTitle: "Section Title"});

    // 3. Add 1+ objects (Tables, Shapes, etc.) to the Slide
    slide.addText(
        active_project.DisplayName,
        {
            x: 0.5,
            y: 1.2,
            w: "42%",
    ...
    */
    ...
    for (var i = 0; i < quotes.length; ++i) {
        ...
        let quote_slide = pptx.addSlide({masterName: "Face", sectionTitle: "Quotes"});
    ...
    pptx.writeFile({fileName: active_project.DisplayName.replace('.', ' ') + ".pptx"});
...
function DownloadPowerPoint_WeeklyAttitudePulse(data) {
    ...
    pptx.defineSlideMaster({
        ...
        objects: [
            {image: {path: 'mckinsey_logo.jpg', x: 0.4, y: 0.15, w: logo_width, h: logo_width * logo_ratio}},
            {image: {path: 'quote.png', x: 0.4, y: 1.5, w: quote_width, h: quote_ratio * logo_ratio}},
            {image: {path: 'pulse.jpg', x: "44%", y: 0, w: face_width, h: face_width * face_ratio}}
        ],
    });
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            if (o.Status == 'OK')
                ...
                fn_error(o); // error handled in API
        },
...
function AddRespondents_Success(o) {
    ...
    new Notify("Success", data.RespondentCount + " email(s) successfully uploaded", 'success', {autoClose: true});
...
function GetProjects_Success(o) {
    ...
    $('#project-list-title').css('display',
        projects.length == 0
            ? 'none'
            : 'unset'
    );
    ...
    switch (projects.length) {
        case 0:
			...
			<div class="signature" style="position: absolute; top: 110px; right: 60px;width: 140px;line-height: 24px; text-align: right;">↑<br><br>${user.UserDisplayName.split(' ')[0]} - add your first project here</div>

			`);
            break;

        case 1:
            $('#project-list-welcome-msg').html(`Let's get that first project rolling, ${user.UserDisplayName.split(' ')[0]}!`);
            break;

        default:
            $('#project-list-welcome-msg').html(`Select an existing research project, or add a new.`);
...
function SendInvitations_Success(o) {
    new Notify("Success", o.Data.EmailCount + ' email invitation(s) sent', 'success', {autoClose: true});
    LoadProjectRespondentCount();
}
